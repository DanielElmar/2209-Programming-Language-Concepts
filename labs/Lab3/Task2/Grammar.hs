...
happyExpList = Happy_Data_Array.listArray (0,57) ([9424,32,512,61440,4,0,13312,26633,18,222,16384,32915,294,589,1178,2356,128,9424,12288,0,0,32768,1,3,4096,53327,36,316,0
	])
...
happyNewToken action sts stk (tk:tks) =
	...
	TokenLet p -> cont 5;
	TokenIn p -> cont 6;
	TokenInt p happy_dollar_dollar -> cont 7;
	TokenVar p happy_dollar_dollar -> cont 8;
	TokenEq p -> cont 9;
	TokenPlus p -> cont 10;
	TokenMinus p -> cont 11;
	TokenTimes p -> cont 12;
	TokenDiv p -> cont 13;
	TokenLParen p -> cont 14;
	TokenRParen  p -> cont 15;
	TokenExpo p -> cont 16;
	_ -> happyError' ((tk:tks), [])
	}
